...
st.markdown('Only accounts in the AWS West Region (as shown above) can be added to the Bridge-2023 Private Exchange. This exchange was set up so that all learners can efficiently consume and provide data on the private exchange set up for the workshop, today. If your account is in the correct region, submit your account locator below.')
